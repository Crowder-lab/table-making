...
remove_silly_drugs <- function(df) {
  silly_drugs <- c(
    "acetaminophen",
    "desonide",
    "tolterodine",
  ...
  df %>%
    filter(!str_to_lower(Name) %in% silly_drugs)
}
...
for (genotype in c("MAPK8IP3", "ZC4H2", "SLC6A1")) {
  ...
  for (extension in c("html", "png", "docx")) {
    gtsave(gt_table, paste0(genotype, " 65.", extension))
  }
}
...
for (genotype in c("MAPK8IP3", "ZC4H2", "SLC6A1")) {
  ...
  for (extension in c("html", "png", "docx")) {
    gtsave(gt_table, paste0(genotype, " 432.", extension))
  }
}
...
for (genotype in c("MAPK8IP3", "ZC4H2", "SLC6A1")) {
  ...
  for (extension in c("html", "png", "docx")) {
    gtsave(gt_table, paste0(genotype, " 10.", extension))
  }
}
